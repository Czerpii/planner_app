...
class NewTaskWindow(ctk.CTkToplevel):
    def __init__(self,parent, task_manager_table_instance):
        ...
        # self.date_entry.insert(0,"Brak")
        # self.date_entry.pack(side = 'left', expand = "true", fill ="both")
    ...
    def save_task_button_click(self):
        ...
        self.task_managere_table_instance.add_to_treeview()
        self.destroy()
        ...
        if self.data_name == 'status':
            for i in range(len(self.data_list)):
                ...
                self.button_parameters = ctk.CTkButton(record_frame, 
                                            ...
                                            command=lambda button_text=self.data_list[i][0]: self.button_parameters_clicked(button_text)
                                            ).pack(side='left')
            ...
            for i in range(len(self.data_list)):
                ...
                ctk.CTkButton(record_frame,
                            text="x",
                            command=lambda parameters=record_frame, index=self.data_list[i][0]: self.button_delete_clicked(parameters, index), 
