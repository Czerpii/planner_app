...
class LoginView(ctk.CTkFrame):
    ...
    def __init__(self, parent):
        """
        Initializes a LoginView instance.
    ...
    def configure_layout(self):
        """
        Configures the layout of the LoginView.
        """
    ...
    def create_userdata_frame(self):
        """
        Creates the user data input frame.
        """
    ...
    def create_login_buttons_frame(self):
        """
        Creates the login buttons frame.
        """
    ...
    def create_additional_buttons(self):
        """
        Creates additional buttons (e.g., registration).
        """
    ...
    def info_label(self):
        """
        Creates an info label to display messages.
        """
...
class RegistrationView(ctk.CTkFrame):
    """
    A class representing the registration view of the application.
    """

    def __init__(self, parent):
        """
        Initializes a RegistrationView instance.
    ...
    def configure_layout(self):
        """
        Configures the layout of the RegistrationView.
        """
        self.columnconfigure((0, 1), weight=1, uniform='b')
        self.rowconfigure(0, weight=2, uniform='b')
    ...
    def create_registration_buttons_frame(self):
        """
        Creates the registration buttons frame.
        """
        self.buttons_frame = ctk.CTkFrame(self, fg_color='transparent')
        self.buttons_frame.grid(column=0, columnspan=2, row=3, sticky='nsew', padx=15,)
